        ...
        <q-tab-panel name="itens">
          ...
          <div class="q-pa-md">
            <div class="row q-gutter-sm">
              ...
              <q-btn size="md" label="Exportar - Excel" color="primary" @click="onexport" icon="print" />
              <q-btn size="md" v-if="Object.keys(selected).length" color="positive" label="Ver Detalhes" @click="verDetalhes(selected[0].id)" icon="toc" />
