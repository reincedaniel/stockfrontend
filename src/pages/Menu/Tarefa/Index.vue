<template>
 <q-page class="flex bg-white">
      <div class="full-width">
        ...
        narrow-indicator
        class="text-grey">
            <q-tab icon="item" name="itens" label="Tarefas"/>
            ...
            <q-tab-panel name="itens">
                    <div class="q-pa-md">
                          <q-banner dense inline-actions class="text-white text-center bg-primary">
                            <label class="text-bold text-h4">{{productToBuy.length}} Tarefas Para Hoje | {{productToBuy.length}} Tarefas Em Atraso</label>
                            <template v-slot:action>
                              <q-btn class="text-primary bg-white" label="Expandir" icon="arrow_right"/>
                            </template>
                          </q-banner>
                      <div class="row q-gutter-sm q-pt-md">
                        <q-input color="primary" autofocus  dense debounce="300" @keyup="serchProduct()" v-model="filter" placeholder="Pesquisar">
...
<!--                         <q-item-label header>Produtos & Serviços</q-item-label> rounded-borders bordered-->
                    ...
                    <div class="row">
                        ...
                        <div class="col q-pr-md">
                          <q-banner inline-actions class="text-white bg-red-9 text-center">
                            <label class="text-bold text-h5">Tarefas Em Atraso <q-icon name="tasks"></q-icon></label>
