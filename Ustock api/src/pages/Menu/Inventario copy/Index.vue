  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: "quantity_input", align: "left", label: "Stock", field: "quantity_input",sortable: true },
...
/*       this.$store.commit("category/resetListCategories");
    ...
    // ****************ADD RPODUCTS
    addArticle() {
//|| this.description == '' || this.description ==null,this.input.internal_code=="" || this.providerValue==""
      if((this.article.description == ""|| this.article.description == null)||(this.providerValue == ""|| this.providerValue == null)) {}
      else {
/* 
          ...
          for (let i in this.listArticles) {
            if (this.listArticles.hasOwnProperty(i)) {
              this.data.push({
                ...
                status: this.listArticles[i].status==true?'Activo':'Inactivo',
